/**
 * @file pcm1681.h
 * @brief Public definitions for the pcm1681 Audio DAC driver
 *
 * @copyright Copyright (c) 2025 Basalte
 *
 */
...
#define PCM1681_FACTORY_REG_0  0x00
#define PCM1681_FACTORY_REG_15 0x0F
